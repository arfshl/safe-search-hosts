...
sed -i d /home/runner/work/safesearch-enforcing-hosts/safesearch-enforcing-hosts/duckduckgo/hosts.txt
...
# Files
tempfile='/home/runner/work/safesearch-enforcing-hosts/safesearch-enforcing-hosts/duckduckgo/supported-domains'
output='/home/runner/work/safesearch-enforcing-hosts/safesearch-enforcing-hosts/duckduckgo/hosts.txt'
...
# echo >> $output
echo "#$IPFour safe.duckduckgo.com" >> $output
#echo "#$IPSix safe.duckduckgo.com">> $output
echo >> $output
